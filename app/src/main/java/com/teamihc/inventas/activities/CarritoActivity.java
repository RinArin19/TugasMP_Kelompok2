...
public class CarritoActivity extends AppCompatActivity
{
    ...
    public void cargarArticulo(String descripcion, int cantidad)
    {
        ...
        for (ArticuloPxQ articulo : carrito.getCarrito())
        {
            ...
            {
                Toast.makeText(this, "Artikel ini telah dipilih", Toast.LENGTH_SHORT).show();
                return;
            }
        }
    ...
    public void aceptar(View view)
    {
        ...
        {
            Toast.makeText(this, "Tidak ada artikel yang telah didaftarkan", Toast.LENGTH_SHORT).show();
            return;
        }

        Venta venta = new Venta(Tasa.obtenerTasa(), new Date(), carrito);
        venta.registrar();
        Toast.makeText(this, "Berhasil mendaftarkan penjualan", Toast.LENGTH_SHORT).show();
        realFinish();
    }
    ...
    {
        referencias_cargadas.setText(carrito.getCarrito().size() + " loaded references.");
    ...
    public void finish(){
        if (fragment.isVisible()){
            ...
            builder.setTitle("Do you want to cancel the purchase?")
